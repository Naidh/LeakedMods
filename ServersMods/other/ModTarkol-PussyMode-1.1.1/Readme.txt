...
5. Hardcore profile launch the mod 2)copy and paste your old profile into user/profiles)
6. Ragfair is activated at level 15.

Note. If someone wants to play with maps that are unlocked without levels para acceder, so copy and replace the Mod with the NoLevelMaps folder. (db/locations)
